...
${structureCore}`,
  ...
  assertMatchesAll(
    ...
    [
      ...
      /applyImmediateStructuralUiMutation\(\s*app,\s*source,\s*\{ hingeDirection: !!nextOn \}/,
      /setUiHingeDirection\(app, !!nextOn, meta\)/,
      /applyImmediateStructuralConfigMutation\(\s*app,\s*source,\s*\{ hingeMap: nextHingeMap \}/,
  ...
  assertLacksAll(
    ...
    [
      ...
      /const actionMeta\s*=\s*\{\s*\.\.\.meta,\s*immediate:\s*true,\s*noBuild:\s*true\s*\}/,
