...
const cases = Object.freeze([
  Object.freeze({
    id: 'corner-cells-ui-defaults-dimension-consolidation',
    entryNumbers: Object.freeze([5]),
    consumer: 'esm/native/features/modules_configuration/corner_cells_ui_defaults.ts',
    consumerSpecifier: '../../../shared/dimensions/corner_cells_ui_defaults_dimension_policy.js',
    owner: 'esm/shared/dimensions/corner_cells_ui_defaults_dimension_policy.ts',
    symbols: Object.freeze(['CM_PER_METER', 'CORNER_WING_BODY_POLICY', 'CORNER_WING_CELL_POLICY']),
    sources: Object.freeze([
      Object.freeze({
        specifier: './corner_system_policy.js',
        symbols: Object.freeze(['CORNER_WING_BODY_POLICY', 'CORNER_WING_CELL_POLICY']),
      }),
      Object.freeze({ specifier: './units.js', symbols: Object.freeze(['CM_PER_METER']) }),
    ]),
  }),
]);
