...
test('[contracts-design-owner] DesignTab owner delegates section orchestration to controller, color, and edit-mode seams', () => {
  ...
  assertMatchesAll(
    ...
    [
      ...
      /useDesignTabEditModes/,
      /applyStructuralUiMutation\(app, 'react:design:doorStyle'/,
      /applyStructuralConfigMutation\(app, source, \{ grooveLinesCount:/,
      /applyStructuralUiMutation\(args\.app, source, uiPatch/,
