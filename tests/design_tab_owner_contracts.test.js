...
test('[contracts-design-owner] DesignTab owner delegates section orchestration to controller, color, and edit-mode seams', () => {
  ...
  assertMatchesAll(
    ...
    [
      ...
      /applyImmediateStructuralUiMutation\(app, source, \{ frontColorShelfInheritanceMode: next \}/,
      /doorStyleSection/,
      /colorSection/,
      /doorFeaturesSection/,
      /corniceSection/,
  ...
  assertMatchesAll(
    ...
    [
      ...
      /useDesignTabEditModes/,
      /applyImmediateStructuralUiMutation\(app, 'react:design:doorStyle'/,
      /applyImmediateStructuralConfigMutation\(app, source, \{ grooveLinesCount:/,
      /applyImmediateStructuralUiMutation\(args\.app, source, uiPatch/,
