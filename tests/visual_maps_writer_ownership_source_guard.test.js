...
test('simple map writes use semantic writers and generic public map writers stay retired', () => {
  ...
  assert.doesNotMatch(mapsWriters, /\bmaps\?\.(?:setHandle|setHinge|setSplit|setSplitBottom)\b/);
  assert.doesNotMatch(mapsWriters, /maps_access\.write(?:Handle|Hinge|Split|SplitBottom)\.ownerRejected/);
