...
test('maps access reports canonical split owner rejection and falls back through owner raw-map recovery', () => {
  ...
  assert.deepEqual(App.maps.splitDoorsMap, { split_d3: true });
  assert.equal(reports.length, 1);
