import { isHexCellDiagonalPanelPartId } from '../hex_cell/index.js';

/**
 * Structural mirror/glass selections are valid only for rendered front visuals
 * that know how to build a special surface. Carcass/frame boards stay ordinary
 * color targets; giving them the mirror material creates dark/untracked panels.
 */
export function isSpecialSurfacePaintTargetPartId(partId: string): boolean {
