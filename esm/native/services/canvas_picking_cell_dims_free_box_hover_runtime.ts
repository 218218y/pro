 ...
 *
 * The hover core owns identity/config/geometry decisions and receives only the
 * five read/raycast capabilities it needs. This adapter is weakly cached because
