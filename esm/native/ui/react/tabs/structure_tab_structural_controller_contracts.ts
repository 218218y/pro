...
export type StructureTabStructuralController = {
  ...
  setBaseLegPlatformSideMode: (next: BaseLegPlatformSideMode) => void;
  setBaseLegPlatformSideOverhangCm: (next: number) => void;
  setBaseLegPlatformFrontOverhangCm: (next: number) => void;
  setStackSplitDecorativeSeparatorSideOverhangCm: (next: number) => void;
  setStackSplitDecorativeSeparatorFrontOverhangCm: (next: number) => void;
