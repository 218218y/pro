...
export function useDesignTabControllerSections(args: {
  ...
  const editModes = useDesignTabEditModes({
    ...
    splitDoorsTransparent: state.splitDoorsTransparent,
  ...
  const doorFeaturesSection = useMemo<DesignTabDoorFeaturesSectionModel>(
    () => ({
      ...
      grooveLinesCountAutoBaseline: state.grooveLinesCountAutoBaseline,
      grooveManualEnabled: state.grooveManualEnabled,
      grooveDraftHeightCm: state.grooveDraftHeightCm,
      grooveDraftWidthCm: state.grooveDraftWidthCm,
      grooveOrientation: state.grooveOrientation,
      splitDoors: state.splitDoors,
      removeDoorsEnabled: state.removeDoorsEnabled,
      ...
      splitDoorsTransparent: editModes.splitDoorsTransparent,
      ...
      toggleGrooveManual: controllerRuntime.toggleGrooveManual,
      setGrooveDraftHeightCm: controllerRuntime.setGrooveDraftHeightCm,
      setGrooveDraftWidthCm: controllerRuntime.setGrooveDraftWidthCm,
      setGrooveOrientation: controllerRuntime.setGrooveOrientation,
      toggleSplitEdit: editModes.toggleSplitEdit,
      toggleSplitCustomEdit: editModes.toggleSplitCustomEdit,
      toggleSplitDoorsTransparent: editModes.toggleSplitDoorsTransparent,
    ...
    [
      ...
      state.grooveLinesCountAutoBaseline,
      state.grooveManualEnabled,
      state.grooveDraftHeightCm,
      state.grooveDraftWidthCm,
      state.grooveOrientation,
      state.splitDoors,
      state.removeDoorsEnabled,
      ...
      controllerRuntime.toggleGrooveManual,
      controllerRuntime.setGrooveDraftHeightCm,
      controllerRuntime.setGrooveDraftWidthCm,
      controllerRuntime.setGrooveOrientation,
      editModes.toggleSplitEdit,
      editModes.toggleSplitCustomEdit,
      editModes.toggleSplitDoorsTransparent,
