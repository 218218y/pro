...
import { handleCanvasClickNDC, handleCanvasHoverNDC, runPerfPhase } from '../services/api.js';
...
export function installUiBootInteractions(
  ...
  try {
    runPerfPhase(App, 'boot.ui.interactions.viewer-resize', 'boot.ui.interactions', () =>
  ...
  runPerfPhase(App, 'boot.ui.interactions.canvas', 'boot.ui.interactions', () =>
    installUiDisposerStrict(
      uiRt,
