// Native Builder Door Visuals (ESM) — Style family seam
//
// Keeps the stable public export surface while delegating each concrete style
// to its own owner. Mirror remains separate in visuals_and_contents_door_visual_mirror.ts.
