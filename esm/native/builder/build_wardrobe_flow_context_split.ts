...
export function resolveBuildWardrobeSplitMetrics(args: {
  ...
  const splitBuildArgs = {
    ...
    stackSplitDecorativeSeparatorSideOverhangCm: plan.stackSplitDecorativeSeparatorSideOverhangCm,
    stackSplitDecorativeSeparatorFrontOverhangCm: plan.stackSplitDecorativeSeparatorFrontOverhangCm,
