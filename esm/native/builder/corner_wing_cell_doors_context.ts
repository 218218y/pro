...
export function createCornerWingDoorContext(params: CornerWingCellFlowParams): CornerWingDoorContext | null {
  ...
  return {
    ...
    cfg0: helpers.cfgSnapshot,
    doorTrimMap: readDoorTrimMap(helpers.cfgSnapshot.doorTrimMap),
    hingeMap0: helpers.readMap('hingeMap'),
    splitMap0: helpers.readMap('splitDoorsMap'),
