...
export function applyModuleContents(
  ...
  if (metrics.drawerHeightTotal > 0) {
    ...
    applyExternalDrawersForModule({
      ...
      addOutlines: runtime.addOutlines ?? null,
      sketchMode: runtime.flags.sketchMode === true,
      getPartMaterial: runtime.getPartMaterial,
      ...(runtime.getPartColorValue !== undefined ? { getPartColorValue: runtime.getPartColorValue } : {}),
      ...(runtime.createDoorVisual !== undefined ? { createDoorVisual: runtime.createDoorVisual } : {}),
      ...(runtime.createInternalDrawerBox !== undefined
