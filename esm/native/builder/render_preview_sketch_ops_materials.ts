...
export function createSketchPlacementPreviewMaterials(
  ...
  return {
    ...
    matCellLayoutSelectedOverlay: createSketchMeshMaterial(THREE, shared, 0xfbbf24, 0.42, false),
    matCellLayoutPeerOverlay: createSketchMeshMaterial(THREE, shared, 0x4fc3f7, 0.28, false),
    matCellLayoutDoorDividerOverlay: createSketchMeshMaterial(THREE, shared, 0x111111, 0.94, false),
