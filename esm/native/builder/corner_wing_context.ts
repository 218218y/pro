...
export function createCornerWingEmitContext(args: {
  ...
  return {
    ...
    baseLegHeightM: state.baseLegHeightM,
    baseLegPlatformMode: state.baseLegPlatformMode,
    baseLegPlatformSideMode: state.baseLegPlatformSideMode,
    baseLegPlatformSideOverhangM: state.baseLegPlatformSideOverhangM,
    baseLegPlatformFrontOverhangM: state.baseLegPlatformFrontOverhangM,
    baseLegBottomPlatformHeightM: state.baseLegBottomPlatformHeightM,
    baseLegTopPlatformHeightM: state.baseLegTopPlatformHeightM,
    baseH: state.baseH,
