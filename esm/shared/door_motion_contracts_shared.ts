...
export const HINGED_DOOR_SHARED_PIVOT_MATCH_TOLERANCE_M =
  HINGED_DOOR_SHARED_PIVOT_DIMENSION_POLICY.sharedPivotMatchToleranceM;
export const HINGED_DOOR_SHARED_PIVOT_VERTICAL_OVERLAP_TOLERANCE_M =
  HINGED_DOOR_SHARED_PIVOT_DIMENSION_POLICY.verticalOverlapToleranceM;
export const HINGED_DOOR_SHARED_PIVOT_PAIR_CLEARANCE_M =
  HINGED_DOOR_SHARED_PIVOT_DIMENSION_POLICY.pairClearanceM;
