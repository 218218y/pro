...
| `oxlint-tsgolint` | `0.24.0`     | `0.24.0`          | `0.24.0`              | Blocking type-aware lint lane.               | Keep exact while type-aware diagnostics are 0; updates require a zero-diagnostic parity run. |
