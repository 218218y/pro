...
| `@types/node`     | `^22.20.1`              | `^22.20.1`   | `^22.20.1`        | `22.20.3`             | `>=22.20.1 <23.0.0`     | Node tool/test type surface aligned to the lowest supported Node runtime major.   | Allow newer Node 22 declaration releases while Node 22 remains the compatibility floor. Node 24 remains the primary runtime.                                                                                                 |
