...
| `oxlint-tsgolint` | `7.0.2002`              | `7.0.2002`   | `7.0.2002`        | `7.0.2002`            | `=7.0.2002`             | Blocking type-aware lint lane.                                                    | Keep the manifest exact. The approved revision follows the resolved lockfile only when its version encoding still matches the pinned TypeScript compiler.                                                                    |
