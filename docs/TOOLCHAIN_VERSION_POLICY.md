...
| `@types/node`     | `^22.20.1`              | `^22.20.1`   | `^22.20.1`        | `22.20.2`             | `>=22.20.1 <23.0.0`     | Node tool/test type surface aligned to the lowest supported Node runtime major.   | Allow newer Node 22 declaration releases while Node 22 remains the compatibility floor. Node 24 remains the primary runtime.                                                                                                 |
| `eslint`          | `^10.8.0`               | `^10.8.0`    | `^10.8.0`         | `10.10.0`             | `>=10.8.0 <11.0.0`      | Strict JS/tools/tests/config lint gate.                                           | Allow ESLint 10 patch/minor releases; major upgrades require a lint policy review.                                                                                                                                           |
| `oxlint`          | `^1.79.0`               | `^1.79.0`    | `^1.79.0`         | `1.83.0`              | `>=1.75.0 <2.0.0`       | Blocking TS/TSX syntax lint gate.                                                 | Allow Oxlint 1.x patch/minor releases while the syntax and type-aware lanes remain at zero diagnostics.                                                                                                                      |
