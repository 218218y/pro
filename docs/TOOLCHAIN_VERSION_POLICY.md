...
| `oxc-parser`      | `0.141.0`               | `0.141.0`    | `0.141.0`         | `0.141.0`             | `=0.141.0`              | Internal AST adapter parser and offline repair dependency.                      | Keep this exact until the lockfile, offline AST archives, manifest checksums, and parser parity tests are refreshed together. |
