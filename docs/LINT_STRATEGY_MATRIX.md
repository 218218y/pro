...
| `no-redeclare`                      | ESLint             | JS, TS, TSX, tools | migrate, runtime | error            | no         | replace-by-oxlint          | Oxlint owns the syntax class; legacy ESLint stays as a temporary compatibility gate until the parser-removal dry-run.                                  |
