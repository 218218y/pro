...
- `ui/react/actions/structural_build_refresh_actions.ts` owns React UI immediate structural patch meta and canonical patch/direct-fallback routing for build-visible Structure, Design, Sketch runtime, Interior drawer, and Handles writes
