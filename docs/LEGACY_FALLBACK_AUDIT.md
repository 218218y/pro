...
Generated at: 2026-04-27T05:59:00.148Z

## Summary

- Source root: `esm`
- Total categorized occurrences: **911**
- Files with occurrences: **286**
- Category counts:
  - `runtime-default`: **722**
  - `browser-adapter`: **18**
  - `project-migration`: **18**
  - `test-fixture`: **7**
  - `legacy-runtime-risk`: **146**
  - `unknown`: **0**
...
- `esm/native/runtime/ui_raw_selectors.ts` — **14** (project-migration: 2, runtime-default: 12)
