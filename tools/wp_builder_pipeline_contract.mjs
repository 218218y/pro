...
requirePattern('esm/native/builder/build_string_normalizer.ts', /export function normalizeBuildStringDefault/);
requirePattern('esm/native/builder/build_string_normalizer.ts', /export function createBuildStringNormalizer/);
requirePattern('esm/native/builder/build_wardrobe_flow_context_setup.ts', /import \{ createBuildStringNormalizer \} from '\.\/build_string_normalizer\.js';/);
...
requirePattern('esm/native/builder/build_wardrobe_flow_execute.ts', /export function executeBuildWardrobeFlow\(prepared: PreparedBuildWardrobeFlow\): BuildContextLike \| null/);
requirePattern('esm/native/builder/build_wardrobe_flow_runtime.ts', /export function runPreparedBuildWardrobeFlow\([\s\S]*prepared: PreparedBuildWardrobeFlow/);
requirePattern('esm/native/builder/module_loop_pipeline.ts', /export function buildModulesLoop\(ctx: unknown\)/);
requirePattern('esm/native/builder/sliding_doors_pipeline.ts', /export function applySlidingDoorsIfNeeded\(ctx: BuildContextLike\)/);
requirePattern('esm/native/builder/external_drawers_pipeline.ts', /export function applyExternalDrawersForModule\(\n  params: ApplyExternalDrawersForModuleParams \| null \| undefined\n\): boolean/);
requirePattern('esm/native/builder/internal_drawers_pipeline.ts', /export function makeInternalDrawerCreator\(params: InternalDrawerCreatorParams\): BuilderInternalDrawerCreator/);
