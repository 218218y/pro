...
const CLOSEOUT_LANES = [
  {
    ...
    command: 'npm',
    args: ['run', 'test:verification-control-plane'],
  },
  {
    ...
    command: 'npm',
    args: ['run', 'test:toolchain-surfaces'],
  },
  {
    id: 'build-dist',
  ...
  },
  {
    ...
    command: 'npm',
    args: ['run', 'test:order-pdf-surfaces:pdf-render'],
  },
  {
    id: 'order-pdf-sketch',
    ...
    command: 'npm',
    args: ['run', 'test:order-pdf-surfaces:sketch'],
  },
  {
    ...
    command: 'npm',
    args: ['run', 'test:order-pdf-surfaces:export-overlay'],
  },
  {
    ...
    command: 'npm',
    args: ['run', 'test:order-pdf-surfaces:export-builders'],
  },
  {
    ...
    command: 'npm',
    args: ['run', 'test:order-pdf-surfaces:export-capture'],
  },
  {
    ...
    command: 'npm',
    args: ['run', 'test:order-pdf-surfaces:export-text'],
  },
  {
