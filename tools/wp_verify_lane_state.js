...
export function createVerifyLaneHelpText() {
  return [
    ...
    '  --print      Print the resolved task order before running.',
    '  --dry-run    Print the resolved task order without running it.',
    '  --no-dedupe  Keep duplicate tasks when multiple lanes overlap.',
    '',
    'Available lanes:',
