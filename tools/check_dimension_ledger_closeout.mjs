...
const requiredFiles = Object.freeze([
  ...
  'tools/wp_public_surface_policy.json',
  'tools/wp_wardrobe_dimension_public_surface_manifest.json',
  'tools/wp_wardrobe_dimension_public_surface_semantic_snapshot.json',
  'tests/dimension_migration_final_closeout_contract.test.js',
  'tests/dimension_migration_retirement_inventory_contract.test.js',
  'tests/wardrobe_dimension_runtime_public_surface_contract.test.js',
  'tests/retired_dimension_import_paths_contract.test.js',
...
const steps = Object.freeze([
  ...
  {
    name: 'Supported Runtime public surface contract',
    command: process.execPath,
    args: nodeTestArgs('tests/wardrobe_dimension_runtime_public_surface_contract.test.js'),
    timeoutMs: 120_000,
  },
  {
    name: 'Retired dimension import paths contract',
    command: process.execPath,
    args: nodeTestArgs('tests/retired_dimension_import_paths_contract.test.js'),
    timeoutMs: 120_000,
  },
  {
